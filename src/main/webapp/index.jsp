...
<%@ page import="java.util.List, com.tap.model.Resturant, com.tap.model.User" %>
    ...
    <section class="restaurants" style="background-color: rgb(255, 253, 253)">
        ...
        <div class="restaurant-container">
            <div class="restaurant-item">
                <img src="Images/FoodImages/UBQ.avif" alt="Restaurant 1">
                <h3>UBQ by Barbeque Nation</h3>
                <p>North Indian, Barbecue, Biryani</p>
                <span>40-45 mins</span>
            </div>
            <div class="restaurant-item">
                <img src="Images/FoodImages/Pizza Hut.avif" alt="Restaurant 1">
                <h3>Pizza Hut</h3>
                <p>Pizzas</p>
                <span>40-45 mins</span>
            </div>
            <div class="restaurant-item">
                <img src="Images/FoodImages/wow momo.avif" alt="Restaurant 1">
                <h3>Wow! Momo</h3>
                <p>Tibetan, Healthy Food</p>
                <span>40-45 mins</span>
            </div>
            <div class="restaurant-item">
                <img src="Images/FoodImages/Barbeque nation.avif" alt="Restaurant 1">
                <h3>Barbeque Nation</h3>
                <p>North Indian, Barbecue, Biryani</p>
                <span>40-45 mins</span>
            </div>
            <div class="restaurant-item">
                <img src="Images/FoodImages/subway.avif" alt="Restaurant 1">
                <h3>Subway</h3>
                <p>Salads,Snacks,Deserts</p>
                <span>40-45 mins</span>
            </div>
            <div class="restaurant-item">
                <img src="Images/FoodImages/corner house.avif" alt="Restaurant 1">
                <h3>Corner House Ice Cream</h3>
                <p>Ice Cream, Desearts</p>
                <span>40-45 mins</span>
            </div>
            <div class="restaurant-item">
                <img src="Images/FoodImages/mojo pizza.avif" alt="Restaurant 1">
                <h3>MOJO PIZZA - 2X Toppings</h3>
                <p>Pizzas, Italian, Fast Food,Deserts</p>
                <span>40-45 mins</span>
            </div>
            <div class="restaurant-item">
                <img src="Images/FoodImages/mcDonalds.avif" alt="Restaurant 1">
                <h3>McDonald's</h3>
                <p>Burger, Beaverages</p>
                <span>40-45 mins</span>
            </div>
            <div class="restaurant-item">
                <img src="Images/FoodImages/kfc.avif" alt="Restaurant 1">
                <h3>KFC</h3>
                <p>Burgers, Fast Foods</p>
                <span>40-45 mins</span>
            </div>
            <div class="restaurant-item">
                <img src="Images/FoodImages/burgerking.avif" alt="Restaurant 1">
                <h3>Burger King</h3>
                <p>Burgers, Americans</p>
                <span>40-45 mins</span>
            </div>
            <div class="restaurant-item">
                <img src="Images/FoodImages/wendy's.avif" alt="Restaurant 1">
                <h3>Wendy's Burger</h3>
                <p>Burgers, American Fast Foods</p>
                <span>40-45 mins</span>
            </div>
            <div class="restaurant-item">
                <img src="Images/FoodImages/dominos.avif" alt="Restaurant 1">
