...
<%@ page import="java.util.List, com.tap.model.User, com.tap.model.Resturant, com.tap.daoimplementation.ResturantDAOImpl" %>
...
<body>
    ...
    <section class="restaurants" style="background-color: rgb(255, 253, 253)">
        ...
        List<Resturant> restaurantList = (List<Resturant>) session.getAttribute("restaurantList");
        ...
        <div class="restaurant-item">
            <img src="images/<%= restaurant.getImageUrl() %>" alt="<%= restaurant.getName() %>">
